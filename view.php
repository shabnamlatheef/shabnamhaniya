<html>
  ...
  <body>
   ...
   <td>    </td>
    ...
    <form>
    <div style="background-color:blue;width:100px;height:100px;position:relative;left:200px;top:150px"></div><br><br><br><br><br><br>
    <p style="position:relative;left:200px;top:10px"><button formaction="edit.php">EDIT</button>
    <button>DELETE</button><br>
    <label style="color:pink">_______________________________</label></p></form>
    </body>
  </html>